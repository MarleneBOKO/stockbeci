...
logout:function(){e(".js__logout").on("click",function(e){return e.preventDefault(),
	swal({title:"Déconnecté?",text:"Êtes-vous sûr de vouloir vous déconnecter?",
