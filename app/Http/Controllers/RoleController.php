...
class RoleController extends Controller
{
    ...
    public function getmenurole(Request $request)
    {
        if (!in_array("menu_role", session("auto_action"))) {
            ...
            return view('role.menu', compact('role', 'allmenu', 'auto_menu', 'auto_action'));
        }
    }
    ...
    public function listrole()
    {
        ...
        if(request('rec') == 1){
            if(request('check') != "" && request('check') != null){
                ...
                return view("role.search", compact('list'));
            }else{
        ...
        return view('role.listrole', compact('list'));
    }
    ...
    public function deleterole(Request $request)
    {
        if (!in_array("delete_role", session("auto_action"))) {
            ...
            $addt = new Trace();
            $addt->libelleTrace = "Rôle supprimé : ".$occurence;
    ...
    public function getmodifrole(Request $request)
    {
        if (!in_array("update_role", session("auto_action"))) {
            ...
            return view('role.modifrole', compact('info'));
        }
    }
