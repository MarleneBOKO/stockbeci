...
<div class="col-xs-12"></div>
	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
        <center style="border-radius: 10px;top: 75%;" id="data"></center> @include('flash::message')</center>
		<div class="box-content bordered info js__card">
			
			<h4 class="box-title with-control">
				Importation manuelle : Calcul en cours...{{ App\Providers\InterfaceServiceProvider::pourcent() }}%
			<span class="controls">
	     		<button type="button" class="control fa fa-minus js__card_minus"></button>
			</span>
			</h4>
			<div class="js__card_content">
				@if(in_array("import_commission", session("auto_action")))
					    
        				    <a href="{{route('vcip')}}" class="cibutton btn-sm waves-effect waves-light" >
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
				 <form class="form-horizontal" method="post" action="{{ route('SlistCommission') }}"  enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								@endif
								@if(in_array("import_contrat", session("auto_action")))
									<div class="col-sm-6">
							...
							<div class="form-group">
								@if(in_array("import_commission_hors", session("auto_action")))
								<div class="col-sm-6">
                            ...
                            @if(in_array("import_commission", session("auto_action")) || in_array("import_commission_hors", session("auto_action")) || in_array("import_contrat", session("auto_action")))
        					...
        					<!--div class="form-group" style="display: block;" id="Ajouter">
        						@if(in_array("calcul_commission_manuelle", session("auto_action")))
