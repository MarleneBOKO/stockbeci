	...
	<div class="content">
		<div class="title-on-desktop">
			<svg style="width: 600px; height: 200px" alignment-baseline="middle">
				...
				<text x="300" y="190" style="width: 600px; height: 200px" text-anchor="middle" font-family="Lato" font-weight="700" font-size="250" fill="#505458" clip-path="url(#clip2)">6<tspan fill="#001e60">4</tspan>9</text>
			</svg>
			<div class="title">ACCES REFFUSER</div>
		</div>
		<h1 class="title-on-mobile">Erreur 649: Le compte n'a pas l'autorisation d'effectuer cette opération.</h1>
