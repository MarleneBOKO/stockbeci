			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="{{ route('SPU') }}"  enctype="multipart/form-data">
              ...
              <div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="{{App\Providers\InterfaceServiceProvider::LibelleRole(session('utilisateur')->Role)}}"  name="role" disabled="true">
									</div>
							    </div>
							    <div class="col-sm-6">
									<label for="inp-type-1" style="vertical-align:middle; margin-top: 1%;" class="col-sm-12  ">Login : </label>
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="{{session('utilisateur')->login}}"  name="log">
									</div>
							    </div>			
							</div>
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="{{session('utilisateur')->nom}}"  name="nom" >
									</div>
							    </div>
								<div class="col-sm-6">
								<label for="inp-type-1" style="vertical-align:middle; margin-top: 1%;" class="col-sm-12">Prénoms : </label>
								<div class="col-sm-12">
									<input type="text" class="form-control" id="inp-type-1" value="{{session('utilisateur')->prenom}}" name="prenom" >
								</div>
							    </div>			
							</div>
							...
							<div class="form-group">	
									...
									<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<input type="text" class="form-control" id="inp-type-1"  name="tel" value="{{session('utilisateur')->tel}}" >
										</div>
									</div>
							</div>
							...
							<div class="form-group">	
									<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<input type="text" class="form-control" id="inp-type-1"  name="adr" value="{{session('utilisateur')->adresse}}" >
										</div>
									</div>								
									...
									<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<input type="text" class="form-control" id="inp-type-1"  name="email" value="{{session('utilisateur')->mail}}" >
										</div>
									</div>
							</div>
							...
							<div class="form-group">	
									<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<input type="text" class="form-control" id="inp-type-1"  name="autr" value="{{session('utilisateur')->other}}" >
										</div>
									</div>								
									...
									<div class="col-sm-6">
										...
										<div class="profile-img-container">
											<div class="img-block">
												...
												@else
												<img class="profile-image" id="profile-image" src="{{session('utilisateur')->image }}" style="border-radius: 50%;" >
												@endif
                      ...
                      <input type="file" hidden id="image-input" name="photoavatar">
									...
									<div class="col-sm-6">
										...
										<div class="profile-img-container">
											<div class="img-block">
												@if(session('utilisateur')->signature == "" || session('utilisateur')->signature == null)
												<img class="profile-image" id="sign-image" src="assets/images/defaut.png" style="border-radius: 50%;" >
												@else
												<img class="profile-image" id="sign-image" src="{{session('utilisateur')->signature }}" style="border-radius: 50%;" >
												@endif
